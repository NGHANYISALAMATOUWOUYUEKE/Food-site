          ...
          <div
            className={
              getTotalCartAmount() === 0
                ? ""
                : "dot absolute bg-[tomato] min-w-[10px] min-h-[10px] rounded-[5px] top-[-8px] right-[-8px] "
            }
          ></div>
        </div>
        {!token ? (
          ...
          <div className="navbar-profile relative hover:flex hover:flex-col hover:gap-[10px] hover:bg-[#fff2ef] hover:py-[12px] hover:px-[25px] hover:rounded-[4px] hover:border-1 hover:border-[tomato] hover:outline-[2px] hover:outline-white ">
            <img src={assets.profile_icon} alt="" />
            <ul className="nav-profile-dropdown absolute right-0 z-10 flex flex-col bg-[#fff2ef] py-[12px] px-[25px] rounded-[4px] border-1 border-[tomato] outline-[2px] outline-white ">
              <li>
